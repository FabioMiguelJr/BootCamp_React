...
//Retornar o nth (enésimo) elemento do array
console.log(_.nth(cars, 3));
console.log(_.nth(cars, -3));
console.log(_.nth(cars, 7)); // Fora do range, trará um valor undefinido
...
_.delay(() => console.log("Atrasado"), 150);
