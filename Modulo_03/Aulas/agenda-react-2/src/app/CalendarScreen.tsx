...
import { getCalendarsEndpoit, getEventsEndpoit, ICalendar, IEvent, IUser } from "./backend";
...
export default function CalendarScreen(props: ICalendarScreenProps) {
	...
	// VAriáveis de estado e suas modificadores
	...
	return (
		<Box display="flex" height="100%" alignItems="stretch">
			...
			<Box flex="1" display="flex" flexDirection="column">
				<CalendarHeader month={month} user={props.user} onSingOut={props.onSingOut} />
