...
export function getUserEndpoit(): Promise<IUser> {
	return fetch(`http://localhost:8080/auth/user`, {
		credentials: "include",
	}).then(handleResponse);
}

export function signInEndpoit(email: string, password: string): Promise<IUser> {
...
export function signOutEndpoit(): Promise<IUser> {
